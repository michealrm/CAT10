...
public class CAT10Util {
    ...
    public static AdderOutput fullAdderByte(byte carryIn, byte a, byte b) {
        ...
        AdderOutput s1 = fullAdder(carryIn, (byte)((a & 0x2)>>1), (byte) ((byte) ((b & 0x2)>>1) ^ s0.carryOut));
        AdderOutput s2 = fullAdder(carryIn, (byte)((a & 0x4)>>2), (byte) ((byte) ((b & 0x4)>>2) ^ s1.carryOut));
        AdderOutput s3 = fullAdder(carryIn, (byte)((a & 0x8)>>3), (byte) ((byte) ((b & 0x8)>>3) ^ s2.carryOut));
        AdderOutput s4 = fullAdder(carryIn, (byte)((a & 0x10)>>4), (byte) ((byte) ((b & 0x10)>>4) ^ s3.carryOut));
        AdderOutput s5 = fullAdder(carryIn, (byte)((a & 0x20)>>5), (byte) ((byte) ((b & 0x20)>>5) ^ s4.carryOut));
        AdderOutput s6 = fullAdder(carryIn, (byte)((a & 0x40)>>6), (byte) ((byte) ((b & 0x40)>>6) ^ s5.carryOut));
        AdderOutput s7 = fullAdder(carryIn, (byte)((a & 0x80)>>7), (byte) ((byte) ((b & 0x80)>>7) ^ s6.carryOut));
