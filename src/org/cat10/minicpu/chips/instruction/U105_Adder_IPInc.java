...
public class U105_Adder_IPInc extends Chip {
    ...
    public void evaluateOut() {
        CAT10Util.AdderOutput upperByteOutput = CAT10Util.fullAdderByte((byte) 0, getChip("U15").getOutput("IPLower"), getChip("U500").getOutput("InstLen"));
        CAT10Util.AdderOutput lowerByteOutput = CAT10Util.fullAdderByte((byte) 0, getChip("U15").getOutput("IPUpper"), upperByteOutput.carryOut);
